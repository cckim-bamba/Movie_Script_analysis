...
QUESTIONS = {
    ...
    "genre_mix": {
        "prompt": "이 영화의 장르 구성 비율을 분석하여 [장르1 40%, 장르2 30%, 장르3 30%] 형식으로, 합이 100%가 되도록 괄호 포함 리스트만 출력해 주세요. 영화장르는 [드라마, 로맨스, 코미디, 범죄, 스릴러, 공포, SF/판타지, 액션, 어드벤처, 전쟁, 재난, 뮤지컬, 아동/청소년, 종교, 시대극] 중에서 고릅니다. 설명 없이 결과만 출력해 주세요.",
        "output_format": "리스트"
    },
    "similar_movies": {
