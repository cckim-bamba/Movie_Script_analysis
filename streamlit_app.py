...
QUESTIONS = {
    ...
    "genre_mix": {
        "prompt": "이 영화의 장르 구성 비율을 분석해 [장르1 40%, 장르2 30%, 장르3 30%] 형태로 리스트만 출력하세요. 장르는 [드라마, 로맨스, 코미디, 범죄, 스릴러, 공포, SF/판타지, 액션, 어드벤처, 전쟁, 재난, 뮤지컬, 아동/청소년, 종교, 시대극] 중에서 고르세요.",
        "output_format": "리스트"
    },
    "similar_movies": {
    ...
    "hit_ganre": {
        "prompt": "장르 측면에서 흥행 가능성을 문장 도입없이 분석요소만 간단히 기술해 주세요.",
        "output_format": "문장"
    },
    "hit_charactor": {
        "prompt": "주인공 감정선과 매력도 측면에서 흥행 가능성을 문장 도입없이 분석요소만 간단히 기술해 주세요.",
        "output_format": "문장"
    },
    "hit_story": {
        "prompt": "주제 측면에서 흥행 가능성을 문장 도입없이 분석요소만 간단히 기술해 주세요.",
        "output_format": "문장"
    }
}
