...
QUESTIONS = {
    "summary": {
        "prompt": "이 대본의 줄거리를 1000자 이내로 기-승-전-결 구조로 요약해 주세요.",
        "output_format": "문장"
    },
    "conflict_structure": {
    ...
    "hit_ganre": {
        "prompt": "이 영화가 흥행할수 있는지 장르 결합 측면에서 평가해서 한문장으로 설명해줘.",
        "output_format": "문장"
    },
    "hit_charactor": {
        "prompt": "이 영화가 흥행할수 있는지 주인공의 감정선과 매력도 측면에서 한문장으로 평가해줘.",
        "output_format": "문장"
    },
    "hit_story": {
        "prompt": "이 영화가 흥행할수 있는지 영화의 주제 측면에서 한문장으로 평가해줘.",
        "output_format": "문장"
    }
}
